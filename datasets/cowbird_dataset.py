...
class CowbirdDataset(torch.utils.data.Dataset):
    """
    ...
    def __init__(self, root, annfile, scale_factor=0.25,
                 output_size=256, transform=None):
        self.root = root
        ...
        self.output_factor = output_size
